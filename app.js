...
const DEMO = {
  staff: [
    { id:  1, name: '佐藤 健一',   role: ROLES.ADMIN,      state: STATES.PRE_WORK,      store: '渋谷店', age: 42, hourlyRate: null, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id:  2, name: '高橋 美智子', role: ROLES.ADMIN,      state: STATES.PRE_WORK,       store: '新宿店', age: 38, hourlyRate: null, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id:  3, name: '山田 太郎',   role: ROLES.MANAGER,    state: STATES.PRE_WORK,      store: '渋谷店', age: 35, hourlyRate: null, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id:  4, name: '鈴木 恵子',   role: ROLES.MANAGER,    state: STATES.PRE_WORK,     store: '新宿店', age: 31, hourlyRate: null, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id:  5, name: '伊藤 誠',     role: ROLES.MANAGER,    state: STATES.PRE_WORK,  store: '池袋店', age: 40, hourlyRate: null, clockIn: null, clockOut: null, breakMin: 0, overtimeMin: 0,  note: '出勤前' },
    { id:  6, name: '渡辺 美香',   role: ROLES.MANAGER,    state: STATES.PRE_WORK,             store: '渋谷店', age: 29, hourlyRate: null, clockIn: null, clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id:  7, name: '田中 花子',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK, store: '渋谷店', age: 20, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id:  8, name: '中村 拓也',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,   store: '新宿店', age: 19, hourlyRate: 1100, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id:  9, name: '小林 さくら', role: ROLES.PART_TIME,  state: STATES.PRE_WORK,   store: '池袋店', age: 17, hourlyRate: 1050, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前', isMinor: true },
    { id: 10, name: '加藤 健太',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK, store: '渋谷店', age: 22, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 11, name: '吉田 あおい', role: ROLES.PART_TIME,  state: STATES.PRE_WORK,   store: '新宿店', age: 25, hourlyRate: 1200, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 12, name: '山本 勇気',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK, store: '渋谷店', age: 21, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 13, name: '松本 優',     role: ROLES.PART_TIME,  state: STATES.PRE_WORK, store: '池袋店', age: 18, hourlyRate: 1050, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前', isMinor: true },
    { id: 14, name: '井上 彩花',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK, store: '新宿店', age: 23, hourlyRate: 1180, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 15, name: '木村 蓮',     role: ROLES.PART_TIME,  state: STATES.PRE_WORK, store: '渋谷店', age: 20, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 16, name: '林 奈々',     role: ROLES.PART_TIME,  state: STATES.PRE_WORK,     store: '渋谷店', age: 22, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 17, name: '清水 航',     role: ROLES.PART_TIME,  state: STATES.PRE_WORK,     store: '新宿店', age: 24, hourlyRate: 1200, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 18, name: '山崎 柚子',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,     store: '池袋店', age: 19, hourlyRate: 1100, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 19, name: '森 悠斗',     role: ROLES.PART_TIME,  state: STATES.PRE_WORK,            store: '渋谷店', age: 20, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 20, name: '池田 莉子',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,            store: '新宿店', age: 21, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 21, name: '橋本 颯太',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,            store: '渋谷店', age: 18, hourlyRate: 1050, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前', isMinor: true },
    { id: 22, name: '阿部 千夏',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,             store: '渋谷店', age: 23, hourlyRate: 1180, clockIn: null, clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 23, name: '石川 大翔',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,             store: '新宿店', age: 25, hourlyRate: 1200, clockIn: null, clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 24, name: '前田 みずき', role: ROLES.PART_TIME,  state: STATES.PRE_WORK,             store: '池袋店', age: 22, hourlyRate: 1150, clockIn: null, clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 25, name: '藤田 蒼',     role: ROLES.PART_TIME,  state: STATES.PRE_WORK,             store: '渋谷店', age: 20, hourlyRate: 1150, clockIn: null, clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 26, name: '岡田 里奈',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,             store: '新宿店', age: 19, hourlyRate: 1100, clockIn: null, clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 27, name: '後藤 翔平',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,             store: '渋谷店', age: 26, hourlyRate: 1250, clockIn: null, clockOut: null,    breakMin: 0, overtimeMin: 0,   note: '出勤前' },
    { id: 28, name: '長谷川 葵',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,            store: '渋谷店', age: 21, hourlyRate: 1150, clockIn: null, clockOut: null,    breakMin: 0, overtimeMin: 0,   note: '出勤前' },
    { id: 29, name: '村田 晴菜',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,            store: '池袋店', age: 20, hourlyRate: 1100, clockIn: null, clockOut: null,    breakMin: 0, overtimeMin: 0,   note: '出勤前' },
    { id: 30, name: '近藤 朔',     role: ROLES.PART_TIME,  state: STATES.PRE_WORK,            store: '新宿店', age: 24, hourlyRate: 1200, clockIn: null, clockOut: null,    breakMin: 0, overtimeMin: 0,   note: '出勤前' },
    { id: 31, name: '藤井 結月',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,             store: '渋谷店', age: 22, hourlyRate: 1150, clockIn: null, clockOut: null,    breakMin: 0, overtimeMin: 0,   note: '出勤前' },
    { id: 32, name: '西村 拓海',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,             store: '新宿店', age: 28, hourlyRate: 1300, clockIn: null, clockOut: null,    breakMin: 0, overtimeMin: 0,   note: '出勤前' },
    { id: 33, name: '福田 ひより', role: ROLES.PART_TIME,  state: STATES.PRE_WORK,     store: '渋谷店', age: 20, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 34, name: '岡本 亮',     role: ROLES.PART_TIME,  state: STATES.PRE_WORK,     store: '池袋店', age: 23, hourlyRate: 1180, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 35, name: '遠藤 菜々美', role: ROLES.PART_TIME,  state: STATES.PRE_WORK,     store: '新宿店', age: 19, hourlyRate: 1100, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 36, name: '青木 陸',     role: ROLES.PART_TIME,  state: STATES.PRE_WORK,     store: '渋谷店', age: 21, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 37, name: '竹内 ゆか',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,     store: '池袋店', age: 22, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 38, name: '金子 海斗',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,  store: '渋谷店', age: 24, hourlyRate: 1200, clockIn: null, clockOut: null, breakMin: 0, overtimeMin: 0,   note: '出勤前' },
    { id: 39, name: '工藤 美羽',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,  store: '新宿店', age: 20, hourlyRate: 1150, clockIn: null, clockOut: null, breakMin: 0, overtimeMin: 0,   note: '出勤前' },
    { id: 40, name: '和田 一輝',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,  store: '池袋店', age: 22, hourlyRate: 1150, clockIn: null, clockOut: null, breakMin: 0, overtimeMin: 0,  note: '出勤前' },
    { id: 41, name: '斎藤 えみか', role: ROLES.PART_TIME,  state: STATES.PRE_WORK,  store: '渋谷店', age: 21, hourlyRate: 1150, clockIn: null, clockOut: null, breakMin: 0, overtimeMin: 0,   note: '出勤前' },
    { id: 42, name: '横山 蓮太',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,  store: '新宿店', age: 25, hourlyRate: 1250, clockIn: null, clockOut: null, breakMin: 0, overtimeMin: 0,   note: '出勤前' },
    { id: 43, name: '内田 朱音',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,      store: '渋谷店', age: 23, hourlyRate: 1180, clockIn: null, clockOut: null, breakMin: 0, overtimeMin: 0,   note: '出勤前' },
    { id: 44, name: '宮崎 大空',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,      store: '池袋店', age: 20, hourlyRate: 1150, clockIn: null, clockOut: null, breakMin: 0, overtimeMin: 0,   note: '出勤前' },
    { id: 45, name: '田村 葉月',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,      store: '新宿店', age: 19, hourlyRate: 1100, clockIn: null, clockOut: null, breakMin: 0, overtimeMin: 0,   note: '出勤前' },
    { id: 46, name: '原田 悠真',   role: ROLES.PART_TIME,  state: STATES.PRE_WORK,      store: '渋谷店', age: 26, hourlyRate: 1300, clockIn: null, clockOut: null, breakMin: 0, overtimeMin: 0,  note: '出勤前' },
    { id: 47, name: '松田 柊',     role: ROLES.PART_TIME,  state: STATES.PRE_WORK,       store: '渋谷店', age: 22, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
    { id: 48, name: '石田 あかり', role: ROLES.PART_TIME,  state: STATES.PRE_WORK,       store: '新宿店', age: 21, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: '出勤前' },
