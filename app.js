...
const DEMO = {
  staff: [
    ...
    { id: 31, name: '藤井 結月',   role: ROLES.PART_TIME,  state: STATES.WORKING,             store: '渋谷店', age: 22, hourlyRate: 1150, clockIn: '10:00', clockOut: null,    breakMin: 60, overtimeMin: 0,   note: '夕方まで勤務中' },
    { id: 32, name: '西村 拓海',   role: ROLES.PART_TIME,  state: STATES.WORKING,             store: '新宿店', age: 28, hourlyRate: 1300, clockIn: '09:00', clockOut: null,    breakMin: 60, overtimeMin: 0,   note: '午前番' },
    { id: 33, name: '福田 ひより', role: ROLES.PART_TIME,  state: STATES.SHIFT_PUBLISHED,     store: '渋谷店', age: 20, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: 'シフト確認済み' },
    { id: 34, name: '岡本 亮',     role: ROLES.PART_TIME,  state: STATES.SHIFT_PUBLISHED,     store: '池袋店', age: 23, hourlyRate: 1180, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: 'シフト確認済み' },
    { id: 35, name: '遠藤 菜々美', role: ROLES.PART_TIME,  state: STATES.SHIFT_PUBLISHED,     store: '新宿店', age: 19, hourlyRate: 1100, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: 'シフト確認済み' },
    { id: 36, name: '青木 陸',     role: ROLES.PART_TIME,  state: STATES.SHIFT_PUBLISHED,     store: '渋谷店', age: 21, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: 'シフト確認済み' },
    { id: 37, name: '竹内 ゆか',   role: ROLES.PART_TIME,  state: STATES.SHIFT_PUBLISHED,     store: '池袋店', age: 22, hourlyRate: 1150, clockIn: null,    clockOut: null,    breakMin: 0,  overtimeMin: 0,   note: 'シフト確認済み' },
